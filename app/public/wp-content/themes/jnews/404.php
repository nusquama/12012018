                ...
                <div class="jeg_section">
                    <div class="container">
                        <div class="jeg_404_content row">
                            ...
                            <div class="jeg_main_content jeg_column col-sm-<?php echo esc_attr($notfound->get_content_width()); ?>">
                            ...
                            <?php if($notfound->get_content_show_sidebar()) : ?>
                                <div class="jeg_sidebar <?php echo esc_attr( $notfound->get_sticky_sidebar() ); ?> jeg_column col-sm-4">
                                    <?php jnews_widget_area( $notfound->get_content_sidebar() ); ?>
                                </div>
                            <?php endif; ?>
