function jnewsSetSettingValue( setting, value ) {
    /**
    ...
    if ( 'jnews-checkbox' === controlType || 'jnews-switch' === controlType || 'jnews-toggle' === controlType ) {
        ...
        // Update the value visually in the control
        alphaColorControl = wp.customize.control( setting ).container.find( '.jnews-color-control' );
        ...
        if ( undefined !== value.color ) {
            ...
            // Update the value visually in the control
            typographyColor = wp.customize.control( setting ).container.find( '.jnews-color-control' );
