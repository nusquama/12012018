wp.customize.controlConstructor['jnews-multicolor'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		function jnewsMulticolorChangeHandler( control, value, subSetting ) {
		...
		while ( i < Object.keys( colors ).length ) {
			...
			jnewsMulticolorChangeHandler( this, value, keys[ i ] );
