...
Class Repeater extends ControlAbstract {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'jnews-repeater', JEG_URL . '/assets/js/customizer-control/control-repeater.js', array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable', 'serialize-js'), null, true );
	}
