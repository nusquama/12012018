...
(function($){
	...
	$.type_video_vimeo = function (ele, autoplay, repeat) {
		...
		var iframe = '<iframe src="//player.vimeo.com/video/' + vimeo_id + '?' + additionalstring + 'title=0&byline=0&portrait=0" width="700" height="500" frameborder="0"></iframe>';
		$('.jeg_video_container', ele).append(iframe);
	};
...
(function($) {
	...
	window.jnews.popup =
	{
		...
		expand_single_image_caption: function(element){
			...
			var caption 	= $(figure).find('.wp-caption-text');
		...
		popup_photoswipe : function(){
            ...
            // no caption
            $(base.container).find(".content-inner a")
                .find("a[href$='.gif'], a[href$='.jpg'], a[href$='.png'], a[href$='.bmp']")
		...
		popup_magnific : function()
		{
			...
			var selector_string =
					...
					".content-inner a > img[class*='wp-image']," +
					".content-inner a > img[class*='align']," +
