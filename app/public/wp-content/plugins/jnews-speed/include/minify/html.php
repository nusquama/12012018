...
/**
 * @param $buffer
 * @param string $minify_javascript
 * @param string $minify_html_comments
 * @param string $minify_html_utf8
 * @return mixed
 *
 * Use https://wordpress.org/plugins/minify-html-markup/
 */
function jnews_minify_html_output($buffer, $minify_javascript = 'yes', $minify_html_comments = 'yes', $minify_html_utf8 = 'yes')
{
