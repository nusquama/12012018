 ...
 * Split Option
 */
add_action( 'jnews_register_customizer_option', 'jnews_split_customizer_option');

if(!function_exists('jnews_split_customizer_option'))
{
    function jnews_split_customizer_option()
    {
        require_once 'class.jnews-split-option.php';
        JNews_Split_Option::getInstance();
    }
}
